...
*/
    ...
    {
    	game.physics.arcade.velocityFromRotation(tank.rotation, currentSpeed, tank.body.velocity);
    	//tank.body.velocity.x = -tank.body.velocity.x;
    	//tank.body.velocity.y = -tank.body.velocity.y;
    }
...
function fire () {
    ...
    if (game.time.now > nextFire && bullets.countDead() > 0)
    {
        ...
        var _x = tank.x + 5 * Math.cos(tank.rotation * Math.PI / 180);
        var _y = tank.y + 5 * Math.sin(tank.rotation * Math.PI / 180);

        var _x = tank.x + 500 * Math.cos(tank.rotation);
        var _y = tank.y + 500 * Math.sin(tank.rotation);
        bullet.rotation = game.physics.arcade.moveToXY(bullet, _x, _y, 1000, 500);
    }
